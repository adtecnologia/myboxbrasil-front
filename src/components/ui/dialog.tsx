  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        className={cn(
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 custom-scrollbar fixed top-[50%] left-[50%] z-50 grid max-h-[90vh] w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto rounded-lg border bg-background p-6 shadow-lg duration-300 data-[state=closed]:animate-out data-[state=open]:animate-in",
          className
        )}
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      className={cn("text-font-100 text-sm", className)}
