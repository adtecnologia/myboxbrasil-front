...
const AguardandoRetiradaMapa = ({ permission } : PageDefaultProps) => {
    ...
    return (
        <PageDefault valid={true} items={[
            { title: <Link to="/painel/aguardandoretirada">Aguardando Retirada</Link>, },
            { title: 'Mapa' }
        ]} options={
...
export default AguardandoRetiradaMapa;