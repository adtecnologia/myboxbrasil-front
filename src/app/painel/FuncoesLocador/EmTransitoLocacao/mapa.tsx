...
const EmTransitoLocacaoMapa = ({ permission } : PageDefaultProps) => {
    ...
    return (
        <PageDefault valid={true} items={[
            { title: <Link to="/painel/emtransitolocacao">Em Trânsito Locação</Link>, },
            { title: 'Mapa' }
        ]} options={
...
export default EmTransitoLocacaoMapa;