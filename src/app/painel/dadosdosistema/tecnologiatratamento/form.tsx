...
const TecnologieForm = ({ type, path, permission }: PageDefaultProps) => {
          ...
          {load ? (
            ...
            <CardItem>
              <Form layout="vertical" form={form} onFinish={onSend}>
                <Row gutter={[8, 8]}>
                  <Col xs={24} md={24}>
                    <Form.Item name="name" label="Tratamento" rules={[ { required: true, message: "Campo obrigatório!" }, ]}>
