...
const VehicleList = ({ type, path, permission }: PageDefaultProps) => {
  ...
  // table columns
  const column = [
    { title: "Placa", dataIndex: "plate", table: "plate", width: "160px", sorter: true, align: "center", render: null },
    { title: "Renavam", dataIndex: "renavam", table: "renavam", width: "180px", sorter: true, align: "center", render: null },
    { title: "Marca", dataIndex: "brand", table: "brand", width: "180px", sorter: true, align: "center", render: null },
    { title: "Modelo", dataIndex: "model", table: "model", width: "200px", sorter: true, align: "center", render: null },
    { title: "Tipo de Veículo", dataIndex: "vehicle_type.name", table: "vehicle_types.name", width: "auto", minWidth: "200px", sorter: true, align: "left", render: null },
