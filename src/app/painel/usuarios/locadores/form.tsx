...
import { Button, Col, Form, Input, Modal, Radio, Row, Select, Upload, message } from "antd";
...
const LandlordForm = ({ type, path, permission }: PageDefaultProps) => {
    ...
    const onSend = (values: any) => {
        ...
        fromAddress(address).then(({ results }) => {
            ...
            POST_API(`/user`, {...values, profile_type: doc === 'cpf' ? 'seller' : 'legal_seller'}, ID).then((rs) => {
