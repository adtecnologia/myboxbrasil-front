        ...
        <Col md={24} xs={24}>
          {load ? (
            ...
            <Row gutter={[16, 16]}>
              ...
              {locadores.length === 0 && step > 1 && (
                <Col className="animation-fade" span={24}>
                  <CardItem>
                    <Typography style={{ fontSize: 18, textAlign: "center" }}>
                      Infelizmente não encontramos nenhum locador que atue na
                      sua região.
                    </Typography>
                    <Row
                      gutter={8}
