...
export default function RelatorioLocacoesPorObra() {
  ...
  const onSend = (values: any) => {
    ...
    let url = `/reports/locations-by-address?page=${current}&per_page=${page}&sort=-order_locations.created_at`;
  ...
  return (
    <PageDefault
      items={[{ title: 'Relatório' }, { title: 'Caçambas por obra' }]}
      valid={'rpt.cpo'}
    >
      <Row gutter={[16, 16]}>
        <Col span={24}>
              ...
              <CardItem>
                <Row gutter={[8, 8]}>
                  ...
                  <Col flex={'auto'}>
                    ...
                    >
                      Obra: {item.address_name}
                    </Typography>
                    <Typography>
                      <b>Endereço:</b> {item.client_street} {item.client_number}
